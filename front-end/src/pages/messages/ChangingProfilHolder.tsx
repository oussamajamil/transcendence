...
import { ReactComponent as Points } from "../../assets/vpoint.svg";
...
const ChangingProfilHolder = () => {
  ...
  return (
    <div className=" flex items-center justify-center w-[40px] h-[40px] rounded-[50%] bg-[#6B6B7A]  cursor-pointer absolute top-[1.5rem] right-[2rem] transition ease-in duration-400 hover:bg-[#dfe6ff]   ">
      <div
      ...
      <div className={btnShowUp === false ? "dropProfil" : "dropProfil active"}>
        ...
        <div className="">
          <button className=" flex items-center justify-evenly gap-1 cursor-pointer p-2 transition ease-in duration-300 w-[100%] bg-transparent hover:transition-shadow hover:bg-[#e1e6fd] active:transition:duration-200 active:bg-[#fff]  ">
            <Resetname className="-translate-x-5" />
            <span className=" -translate-x-8 " >Invite Game</span>
          </button>
        </div>
      </div>
    </div>
