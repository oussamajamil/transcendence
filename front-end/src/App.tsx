      ...
      <div className={`flex min-h-[100vh] min-w-[100vw] overflow-auto ${
         ...
         <div className="logo h-[5rem]  p-2 flex ">
          ...
          <div className="menu flex flex-col justify-center gap-1">
            {RouteData.map((item, index) => (
              <motion.button key={index} className={`relative menu-item flex flex-col items-center justify-center h-[6rem] w-[100%] cursor-pointer hover:bg-[#F4F6FF] ${
        ...
        <div className='w-full  flex flex-col'>
        {
          ...
          (
            ...
            <Button variant='text' className='p-2'>
              <Avatar
                src="https://cdn.fakercloud.com/avatars/nelshd_128.jpg"
              />
            </Button>
          </div>
          )
